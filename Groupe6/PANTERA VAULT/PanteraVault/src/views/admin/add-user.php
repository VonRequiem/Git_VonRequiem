...
$dsn = 'mysql:dbname=pantera;host=127.0.0.1:3306';
$user = 'root';
$password = '';
...
if (isset($_POST["nomUser"])) {
    ...
    $sql = "INSERT INTO user (nomUser, prenomUser, ageUser, roleUser, adresseFactureUser, adresseLivraisonUser, dateInscriptionUser, emailUser, mdpUser, statutUser)
            VALUES (:nomUser, :prenomUser, :ageUser, :roleUser, :adresseFactureUser, :adresseLivraisonUser, :dateInscriptionUser, :emailUser, :mdpUser, :statutUser)";
            //INSERT INTO user (nomUser, prenomUser, ageUser, roleUser, adresseFactureUser, adresseLivraisonUser, dateInscriptionUser, emailUser, mdpUser, statutUser, user.adresse_idAdresse) VALUES (":nomUser", ":prenomUser", ":ageUser", ":roleUser", ":adresseFactureUser", ":adresseLivraisonUser", ":dateInscriptionUser", ":emailUser", ":mdpUser", ":statutUser", 1)
...
<div class="container bg-secondary  justify-content-center">
    <form method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control d-flex col-md-6" id="nomUser" name="nomUser" value="">
        </div><br>
        <!--formulaire prenom User-->
        <div class="form-group">
            <label for="prenomUser">Prenom :</label><br>
            <input type="text" class="form-control col-md-6" id="prenomUser" name="prenomUser" value="">
        </div><br>
        <!--formulaire age User-->
        <div class="form-group">
            <label for="ageUser">Age :</label><br>
            <input type="text" class="form-control col-md-6" id="ageUser" name="ageUser" value="">
        </div><br>
        <!--formulaire adresse Facture User-->
        <div class="form-group">
            <label for="adresseFactureUser">Adresse de Facturation :</label><br>
            <input type="text" class="form-control col-md-6" id="adresseFactureUser" name="adresseFactureUser" value="">
        </div><br>
        <!--formulaire adresse Livraison User-->
        <div class="form-group">
            <label for="adresseLivraisonUser">Adresse de livraison :</label><br>
            <input type="text" class="form-control col-md-6" id="adresseLivraisonUser" name="adresseLivraisonUser" value="">
        </div><br>
        <!--formulaire date d'inscription User-->
        <div class="form-group">
            <label for="dateInscriptionUser">Date d'inscription :</label><br>
            <input type="text" class="form-control col-md-6" id="dateInscriptionUser" name="dateInscriptionUser" value="">
        </div><br>
        <!--formulaire mail User-->
        <div class="form-group">
            <label for="emailUser">Mail :</label><br>
            <input type="text" class="form-control col-md-6" id="emailUser" name="emailUser" value="">
        </div><br>
        <!--formulaire mot de passe User-->
        <div class="form-group">
            <label for="mdpUser">Mot de passe :</label><br>
            <input type="text" class="form-control col-md-6" id="mdpUser" name="mdpUser" value="">
        </div><br>
        <!--formulaire rôle User-->
        <div class="form-group">
            <label for="roleUser">Rôle :</label><br>
            <input type="text" class="form-control col-md-6" id="roleUser" name="roleUser" value="">
        </div><br>
        <!--formulaire statut User-->
        <div class="form-group">
            <label for="statutUser">Statut :</label><br>
            <input type="text" class="form-control col-md-6" id="statutUser" name="statutUser" value="">
        </div><br>
