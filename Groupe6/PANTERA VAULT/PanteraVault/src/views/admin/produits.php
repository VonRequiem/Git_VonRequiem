...
<table class="justify-content-center d-flex table-bordered">
    ...
    foreach ($result as $product){
        echo '<tr>';
        echo '<td class="table-secondary">'.$product ['nomProduct'].'</td>';
        echo '<td class="table-secondary">'.$product ['marqueProduct'].'</td>';
        echo '<td class="table-secondary">'.$product ['typeProduct'].'</td>';
        echo '<td class="table-secondary">'.$product ['prixProduct'].'</td>';
        echo '<td class="table-secondary">'.$product ['distributeurProduct'].'</td>';
        echo '<td class="table-secondary">'.$product ['descriptionCourteProduct'].'</td>';
        echo '<td class="table-secondary">'.$product ['descriptionLongueProduct'].'</td>';
        echo '<td class="table-warning"><a href="produits-detail.php?id='.$product['idProduct'].'">Editer</a>/<a href="delete-product.php?id='.$product['idProduct'].'">supprimer</a></td>';
        echo '</tr>';
    }
    ?>
</table>
