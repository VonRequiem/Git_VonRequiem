...
if (isset ($_GET ['id'])) {
    ...
    header('Location: produits-detail.php');
}
...
//
    //];
    $sql = "UPDATE product SET nomProduct = :nomProduct,
                                marqueProduct = :marqueProduct, 
                                typeProduct = :typeProduct, 
                                prixProduct = :prixProduct, 
                                distributeurProduct = :distributeurProduct, 
    ...
    $stmt->bindParam(':nomProduct', $nomProduct, PDO::PARAM_STR);
    $stmt->bindParam(':marqueProduct', $marqueProduct, PDO::PARAM_STR);
    $stmt->bindParam(':typeProduct', $typeProduct, PDO::PARAM_STR);
    $stmt->bindParam(':prixProduct', $prixProduct, PDO::PARAM_STR);
    $stmt->bindParam(':distributeurProduct', $distributeurProduct, PDO::PARAM_STR);
    $stmt->bindParam(':descriptionCourteProduct', $descriptionCourteProduct, PDO::PARAM_STR);
    $stmt->bindParam(':descriptionLongueProduct', $descriptionLongueProduct, PDO::PARAM_STR);
...
$sth = $dbh->prepare("SELECT * FROM product WHERE idProduct = :id");
$sth->execute(['id' => $id]);
...
<form method="post">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control col-md-6" id="nomProduct" name="nomProduct" value="<?php echo $result['nomProduct']?>">
    </div><br>
    <!--formulaire marque Product-->
    <div class="form-group">
        <label for="marqueProduct">Marque</label><br>
        <input type="text" class="form-control col-md-6" id="marqueProduct" name="marqueProduct" value="<?php echo $result['marqueProduct']?>">
    </div><br>
    <!--formulaire type Product-->
    <div class="form-group">
        <label for="typeProduct">Type de produit</label><br>
        <input type="text" class="form-control col-md-6" id="typeProduct" name="typeProduct" value="<?php echo $result['typeProduct']?>">
    </div><br>
    <!--formulaire distributeur Product-->
    <div class="form-group">
        <label for="distributeurProduct">Distributeur</label><br>
        <input type="text" class="form-control col-md-6" id="distributeurProduct" name="distributeurProduct" value="<?php echo $result['distributeurProduct']?>">
    </div><br>
    <!--formulaire prix Product-->
    <div class="form-group">
        <label for="prixProduct">Prix</label><br>
        <input type="text" class="form-control col-md-6" id="prixProduct" name="prixProduct" value="<?php echo $result['prixProduct']?>">
    </div><br>
    <!--formulaire description courte Product-->
    <div class="form-group">
        <label for="descriptionCourteProduct">Description courte produit</label><br>
        <textarea class="form-control col-md-6" id="descriptionCourteProduct" rows="3" name="descriptionCourteProduct"><?php echo $result['descriptionCourteProduct']?></textarea>
    </div><br>
    <!--formulaire description longue Product-->
    <div class="form-group">
        <label for="descriptionLongueProduct">Description Longue produit</label><br>
        <textarea class="form-control col-md-6" id="descriptionLongueProduct" rows="3" name="descriptionLongueProduct"><?php echo $result['descriptionLongueProduct']?></textarea>
    </div><br>
    ...
    <a href="add-product.php"><button type="button" class="btn btn-success">Ajouter</button></a>
</form>
</div>
