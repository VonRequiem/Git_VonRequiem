...
if (isset($_POST["nomMusiciens"])) {
    ...
    //
        //];
    $sql = "UPDATE musiciens SET nomMusiciens = :nomMusiciens,
                                prenomMusiciens = :prenomMusiciens, 
                                ageMusiciens = :ageMusiciens, 
                                roleMusiciens = :roleMusiciens, 
                                descriptionCourteMusiciens = :descriptionCourteMusiciens, 
                                descriptionLongueMusiciens = :descriptionLongueMusiciens 
                                WHERE idMusiciens = :id";
    $stmt= $dbh->prepare($sql);
    $stmt->bindParam(':nomMusiciens', $nomMusiciens, PDO::PARAM_STR);
    $stmt->bindParam(':prenomMusiciens', $prenomMusiciens, PDO::PARAM_STR);
    $stmt->bindParam(':ageMusiciens', $ageMusiciens, PDO::PARAM_STR);
    $stmt->bindParam(':roleMusiciens', $roleMusiciens, PDO::PARAM_STR);
    $stmt->bindParam(':descriptionCourteMusiciens', $descriptionCourteMusiciens, PDO::PARAM_STR);
    $stmt->bindParam(':descriptionLongueMusiciens', $descriptionLongueMusiciens, PDO::PARAM_STR);
...
<form method="post">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control d-flex col-md-6" id="nomMusiciens" name="nomMusiciens" value="<?php echo $result['nomMusiciens']?>">
    </div><br>
    <!--formulaire prenom musiciens-->
    <div class="form-group">
        <label for="prenomMusiciens">Prenom</label><br>
        <input type="text" class="form-control d-flex col-md-6" id="prenomMusiciens" name="prenomMusiciens" value="<?php echo $result['prenomMusiciens']?>">
    </div><br>
    <!--formulaire age musiciens-->
    <div class="form-group">
        <label for="ageMusiciens">Age</label><br>
        <input type="text" class="form-control d-flex col-md-6" id="ageMusiciens" name="ageMusiciens" value="<?php echo $result['ageMusiciens']?>">
    </div><br>
    <!--formulaire rôle musiciens-->
    <div class="form-group">
        <label for="roleMusiciens">Rôle</label><br>
        <input type="text" class="form-control d-flex col-md-6" id="roleMusiciens" name="roleMusiciens" value="<?php echo $result['roleMusiciens']?>">
    </div><br>
    <!--formulaire description courte musiciens-->
    <div class="form-group">
        <label for="descriptionCourteMusiciens">Description courte musicien</label><br>
        <textarea class="form-control d-flex col-md-6" id="descriptionCourteMusiciens" rows="3" name="descriptionCourteMusiciens"><?php echo $result['descriptionCourteMusiciens']?></textarea>
    </div><br>
    <!--formulaire description longue musiciens-->
    <div class="form-group">
        <label for="descriptionLongueMusiciens">Description Longue musicien</label><br>
        <textarea class="form-control d-flex col-md-6" id="descriptionLongueMusiciens" rows="3" name="descriptionLongueMusiciens"><?php echo $result['descriptionLongueMusiciens']?></textarea>
    </div><br>
    ...
    <a href="add-musiciens.php"><button type="button" class="btn btn-success">Ajouter</button></a>
</form>
</div>
