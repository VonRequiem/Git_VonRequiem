...
<?php
$sth = $dbh->prepare("SELECT * FROM musiciens");
$sth->execute();
...
?>
   <div class="container col-md-6 table-responsive">
    <table class="justify-content-center d-flex table-bordered">
        ...
        <?php
        foreach ($result as $musiciens){
            echo '<tr>';
            echo '<td class="table-secondary">'.$musiciens ['nomMusiciens'].'</td>';
            echo '<td class="table-secondary">'.$musiciens ['prenomMusiciens'].'</td>';
            echo '<td class="table-secondary">'.$musiciens ['ageMusiciens'].'</td>';
            echo '<td class="table-secondary">'.$musiciens ['roleMusiciens'].'</td>';
            echo '<td class="table-secondary">'.$musiciens ['descriptionCourteMusiciens'].'</td>';
            echo '<td class="table-secondary">'.$musiciens ['descriptionLongueMusiciens'].'</td>';
            echo '<td class="table-warning"><a href="musiciens-detail.php?id='.$musiciens['idMusiciens'].'">Editer</a>/<a href="delete-musiciens.php?id='.$musiciens['idMusiciens'].'">supprimer</a></td>';
            echo '</tr>';
        }
        ?>
    </table>
